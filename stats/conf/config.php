 ...
 * 
 * SVN FILE $Id: config.php 312 2014-11-22 10:26:50Z joku $
 *  
...
$BBC_DETAILED_STAT_FIELDS = "id, time, ext, dns, ip, visits, os, browser, referer, page";
...
$BBC_IGNORE_IP = "82.244.12.8,82.244.12.40,37.187.7.63";
